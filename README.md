...
<div align="center">
  ...
  <h3><b>To-do App with React</b></h3>
...
This is a Todo app that helps you plan and schedule your day.
It is bootstrapped with [Create React App](https://github.com/facebook/create-react-app). and allows users edit and delete to-do items. Also allows users to make completed todos
...
- **[Add items to the list of todos]**
- **[Update items in the list of todos]**
- **[Mark and delete completed items from the list of todos]**
